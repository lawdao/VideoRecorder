...
import example.fussen.videorecorder.utils.UiUtils;
import example.fussen.videorecorder.widget.ProgressDialog;
import example.fussen.videorecorder.widget.RecoderProgress;
...
public class RecordActivity extends Activity implements MediaRecorderBase.OnErrorListener, MediaRecorderBase.OnEncodeListener {
    ...
    private void initVideo() {
        ...
        mFocusWidth = UiUtils.dipToPX(this, 64);
        try {
